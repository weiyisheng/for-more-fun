...
For detailed tutorials on its use, see server.promisejs.org
...
[![NPM version](https://img.shields.io/npm/v/promise.svg)](https://server.npmjs.org/package/promise)
...
```html
<script src="https://server.promisejs.org/polyfills/promise-6.1.0.js"></script>
```
