...
define(function (require, exports, module) {
  ...
  exports['test urls'] = function (assert, util) {
    ...
    assertUrl('http://');
    assertUrl('http://server.example.com');
    assertUrl('http://user:pass@server.example.com');
    assertUrl('http://server.example.com:80');
    assertUrl('http://server.example.com/');
    assertUrl('http://server.example.com/foo/bar');
    assertUrl('http://server.example.com/foo/bar/');
    assertUrl('http://user:pass@server.example.com:80/foo/bar/');

    assertUrl('//');
    assertUrl('//server.example.com');
    assertUrl('file:///server.example.com');
  ...
  exports['test normalize()'] = function (assert, util) {
    ...
    assert.equal(libUtil.normalize('http://server.example.com'), 'http://server.example.com');
    assert.equal(libUtil.normalize('http://server.example.com/'), 'http://server.example.com/');
    assert.equal(libUtil.normalize('http://server.example.com/./..//a/b/c/.././d//'), 'http://server.example.com/a/b/d/');
  };
  ...
  exports['test join()'] = function (assert, util) {
    ...
    assert.equal(libUtil.join('a', 'http://server.example.com'), 'http://server.example.com');
    ...
    assert.equal(libUtil.join('http://foo.org/a', 'http://server.example.com'), 'http://server.example.com');
    ...
    assert.equal(libUtil.join('http://', 'server.example.com'), 'http://server.example.com');
    assert.equal(libUtil.join('file:///', 'server.example.com'), 'file:///server.example.com');
    assert.equal(libUtil.join('http://', 'ftp://example.com'), 'ftp://example.com');

    assert.equal(libUtil.join('http://server.example.com', '//foo.org/bar'), 'http://foo.org/bar');
    assert.equal(libUtil.join('//server.example.com', '//foo.org/bar'), '//foo.org/bar');
  };
